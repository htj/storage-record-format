...
\begin{itemize}
\item The CapacityUsed property SHOULD be present in the record.
\item The CapacityUsed field type MUST be a positive integer.
\end{itemize}

{\bf Example}
\begin{verbatim}
<ns:CapacityUsed>13617</ns:CapacityUsed>
\end{verbatim}
